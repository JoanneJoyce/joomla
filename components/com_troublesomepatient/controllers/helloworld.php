 ...
 *
 */
class TroublesomePatientControllerTroublesomePatient extends JControllerForm
{   
    public function cancel($key = null)
    {
        ...
        $this->setRedirect(
            ...
            JText::_('New greeting cancelled ok')
		);
    }
    ...
    public function save($key = null, $urlVar = null)
    {
		...
		if (!JFactory::getUser()->authorise( "core.create", "com_troublesomepatient"))
		{
