...
?>
<form action="<?php echo JRoute::_('index.php?option=com_troublesomepatient&view=form&layout=edit'); ?>"
    method="post" name="adminForm" id="adminForm" class="form-validate">

	<div class="form-horizontal">
		<fieldset class="adminform">
			<legend><?php echo JText::_('COM_TROUBLESOME_LEGEND_DETAILS') ?></legend>
			<div class="row-fluid">
				<div class="span6">
