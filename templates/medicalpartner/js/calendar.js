...
Calendar.prototype.create = function (_par) {
    ...
    var hh = function (text, cs, navtype) {
        ...
        cell.colSpan = cs;
        cell.className = "buttonCalendar"; //joanne
...
function checkCalendar(ev)
{
    ...
    for (; el != null; el = el.parentNode) {
        if (el == _calendar.element || el.tagName == "A") break;
    }
    if (el == null) {
...
function showCalendar(id)
{
    ...
    if (_calendar != null) {
        ...
        var cal = new Calendar(false, new Date(), selected, closeHandler);
        cal.setRange(1970, 2037);
        _calendar = cal;
        _calendar.create();
    }
    _calendar.sel = el;
    _calendar.parseDate(el.value);
    _calendar.showAtElement(el);

    Calendar.addEvent(document, "mousedown", checkCalendar);
    return false
}

Calendar._DN = new Array("日", "月", "火", "水", "木", "金", "土", "日");
Calendar._MN = new Array("1月", "2月", "3月", "4月", "5月", "6月",
