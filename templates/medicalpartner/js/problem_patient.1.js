    ...
    // debugger;
     ...
     // Contains functions for getting selected patient on click 
        ...
        var patientBorderOnLoad = function () {
            // Gets all patients
            var patientList = document.getElementById("jform_patient_id");
      ...
      var filter = (function () {
        ...
        var populatePatients = function () {
            patients = document.querySelectorAll("#jform_patient_id option");
        };
    
        // Filters patient list
        var filterPatients = function () {
            var filterInput = document.getElementById('jform_search_patient').value.toUpperCase();
